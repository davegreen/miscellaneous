...
> ServiceUI.exe -process:TSProgressUI.exe %SYSTEMROOT%\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File OSDComputerName.ps1

You can also use the ‘OSDComputerName.cmd’ file provided, which contains detection for which copy of ‘ServiceUI.exe’ to run.